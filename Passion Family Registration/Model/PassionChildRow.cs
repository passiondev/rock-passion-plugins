...
{
    public class PassionChildRow : PreRegistrationChildRow
    {
        ...
        public void SetAttributeValues(PassionPreRegistrationChild child)
        {
            EnsureChildControls();
        ...
        /// </summary>
        /// <param name="child">The child.</param>
        public void GetAttributeValues(PassionPreRegistrationChild child)
        {
            EnsureChildControls();
            int i = 0;
            foreach (var attribute in AttributeList)
    ...
    /// </summary>
    [Serializable]
    public class PassionPreRegistrationChild
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PassionPreRegistrationChild"/> class.
        /// </summary>
        /// <param name="person">The person.</param>
        public PassionPreRegistrationChild(Person person)
        {
            Id = person.Id;
            Guid = person.Guid;
