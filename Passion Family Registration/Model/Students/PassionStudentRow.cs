...
{
    public class PassionStudentRow : PreRegistrationChildRow
    {
        ...
        {
            get { return ViewState["Caption"] as string ?? "Student"; }
        ...
        protected override void CreateChildControls()
        {
            ...
            _tbNickName.RequiredErrorMessage = "First Name is required for all students";
            _tbNickName.Label = "First Name";

            _tbLastName.Required = true;
            _tbLastName.RequiredErrorMessage = "Last Name is required for all students";
            ...
            _ddlGender.RequiredErrorMessage = "Gender is required for all students";
            ...
            _dpBirthdate.RequiredErrorMessage = "Birth date is required for all students";
            ...
            _ddlGradePicker.RequiredErrorMessage = _ddlGradePicker.Label + " is required for all students";
            _ddlGradePicker.Label = "Grade";

            _pnbMobile.CssClass = "form-control";
            _pnbMobile.Label = "Mobile Phone";
            _pnbMobile.RequiredErrorMessage = "A valid phone number is required for all students.";
        ...
        public void SetAttributeValues(PassionPreRegistrationStudent child)
        {
            EnsureChildControls();
        ...
        /// </summary>
        /// <param name="child">The child.</param>
        public void GetAttributeValues(PassionPreRegistrationStudent child)
        {
            EnsureChildControls();
            int i = 0;
            foreach (var attribute in AttributeList)
    ...
    /// </summary>
    [Serializable]
    public class PassionPreRegistrationStudent
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PassionPreRegistrationStudent"/> class.
        /// </summary>
        /// <param name="person">The person.</param>
        public PassionPreRegistrationStudent(Person person)
        {
            Id = person.Id;
            Guid = person.Guid;
