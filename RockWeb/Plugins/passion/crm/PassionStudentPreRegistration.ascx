<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PassionStudentPreRegistration.ascx.cs" Inherits="RockWeb.Plugins.passion.crm.PassionStudentPreRegistration" %>
