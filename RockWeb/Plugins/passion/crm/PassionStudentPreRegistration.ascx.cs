...
", CodeEditorMode.Lava, CodeEditorTheme.Rock, 200, true, "", "", 9)]
    ...
    [CustomCheckboxListField("Locations Displayed", "Which locations should be displayed in the dropdown? NOTE: Always keep blank option selected.", "0^--,3F78A057-21B9-4C20-832D-8F1A6F93539D^515,FB8C406E-721C-40BF-A382-7A9FC3236F1D^Cumberland,D4127B24-E6EE-4117-A688-92BB7C23A461^DC", false, null, "", 0, LOCATIONS_DISPLAYED_KEY)]
...
",
        ...
        private bool ValidateInfo()
        {
            ...
            if (ddlLocation.SelectedValue.IsNullOrWhiteSpace() || ddlLocation.SelectedValue == "0")
            {
