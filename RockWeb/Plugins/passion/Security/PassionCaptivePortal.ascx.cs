...
namespace RockWeb.Plugins.passion.Security
{
    ...
    [BooleanField(
        ...
        IsRequired = true )]
    [TextField(
        name: "Receive Emails Attribute Key",
        description: "The attribute key for the \"Receive e-mail updates\" checkbox attribute.",
        defaultValue: "WifiEmailAuthorization",
        order: 5,
        key: "ReceiveEmailsAttributeKey",
        IsRequired = true)]
    [BooleanField(
        name: "Show Receive Emails Checkbox",
        description: "Show or hide the \"Receive e-mail updates from Passion City Church\" checkbox.",
        defaultValue: false,
        order: 6,
        key: "ShowEmailListCheckbox",
        IsRequired = false)]
    [BooleanField(
    ...
    public partial class PassionCaptivePortal : RockBlock
    {
    ...
    <ol>
        ...
        protected bool ShowControls( bool isEnabled = true )
        {
            ...
            cbReceiveEmails.Text = "Receive e-mail updates from Passion City Church";
            ...
            if ( tbFirstName.Visible || tbLastName.Visible || tbMobilePhone.Visible || tbEmail.Visible || cbAcceptTAC.Visible || cbReceiveEmails.Visible || litLegalNotice.Visible )
            {
                return true;
            }
